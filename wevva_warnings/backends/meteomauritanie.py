"""Provider backend for Mauritania CAP feeds."""
...
class MeteoMauritanieBackend(WarningBackend):
    """Fetch alerts from Mauritania CAP feeds."""

    backend_id = 'meteomauritanie'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Mauritania CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Mauritania CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteomauritanie_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteomauritanie_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Mauritania RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Mauritania RSS feed.
    base_url : str
