"""Provider backend for Liberia Meteorological Service CAP feeds."""
...
class MeteoLiberiaBackend(WarningBackend):
    """Fetch alerts from Liberia Meteorological Service CAP feeds."""

    backend_id = 'meteoliberia'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Liberia CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Liberia CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteoliberia_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteoliberia_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Liberia RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Liberia RSS feed.
    base_url : str
