"""Provider backend for Uzhydromet CAP Atom feeds."""
...
class UzhydrometBackend(WarningBackend):
    """Fetch alerts from Uzhydromet CAP feeds."""

    backend_id = 'uzhydromet'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Uzhydromet CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Uzhydromet CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _uzhydromet_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _uzhydromet_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Uzhydromet Atom feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Uzhydromet Atom feed.
    base_url : str
