"""Provider backend for Comoros CAP feeds."""
...
class MeteoComoresBackend(WarningBackend):
    """Fetch alerts from Comoros CAP feeds."""

    backend_id = 'meteocomores'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Comoros CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Comoros CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteocomores_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteocomores_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Comoros RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Comoros RSS feed.
    base_url : str
