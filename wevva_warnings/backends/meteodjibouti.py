"""Provider backend for Djibouti CAP feeds."""
...
class MeteoDjiboutiBackend(WarningBackend):
    """Fetch alerts from Djibouti CAP feeds."""

    backend_id = 'meteodjibouti'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Djibouti CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Djibouti CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteodjibouti_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteodjibouti_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Djibouti RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Djibouti RSS feed.
    base_url : str
