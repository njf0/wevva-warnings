"""Provider backend for Chad CAP feeds."""
...
class MeteoTchadBackend(WarningBackend):
    """Fetch alerts from Chad CAP feeds."""

    backend_id = 'meteotchad'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Chad CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Chad CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteotchad_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteotchad_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Chad RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Chad RSS feed.
    base_url : str
