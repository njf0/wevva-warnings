"""Provider backend for Zambia CAP feeds."""
...
class ZMDBackend(WarningBackend):
    """Fetch alerts from Zambia CAP feeds."""
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Zambia CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Zambia CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _zmd_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _zmd_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Zambia RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Zambia RSS feed.
    base_url : str
