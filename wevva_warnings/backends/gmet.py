"""Provider backend for Ghana CAP feeds."""
...
class GMETBackend(WarningBackend):
    """Fetch alerts from Ghana CAP feeds."""
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Ghana CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Ghana CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _gmet_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _gmet_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Ghana RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Ghana RSS feed.
    base_url : str
