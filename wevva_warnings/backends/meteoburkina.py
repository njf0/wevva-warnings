"""Provider backend for Burkina Faso CAP feeds."""
...
class MeteoBurkinaBackend(WarningBackend):
    """Fetch alerts from Burkina Faso CAP feeds."""

    backend_id = 'meteoburkina'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Burkina Faso CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Burkina Faso CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteoburkina_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteoburkina_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Burkina Faso RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Burkina Faso RSS feed.
    base_url : str
