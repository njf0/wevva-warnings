"""Provider backend for Kazhydromet CAP Atom feeds."""
...
class KazhydrometBackend(WarningBackend):
    """Fetch alerts from Kazhydromet CAP feeds."""

    backend_id = 'kazhydromet'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Kazhydromet CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Kazhydromet CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _kazhydromet_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _kazhydromet_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Kazhydromet Atom feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Kazhydromet Atom feed.
    base_url : str
