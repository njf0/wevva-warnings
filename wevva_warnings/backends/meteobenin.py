"""Provider backend for METEO-BENIN CAP feeds."""
...
class MeteoBeninBackend(WarningBackend):
    """Fetch alerts from METEO-BENIN CAP feeds."""

    backend_id = 'meteobenin'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a METEO-BENIN CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked METEO-BENIN CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteobenin_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteobenin_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a METEO-BENIN RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the METEO-BENIN RSS feed.
    base_url : str
