"""Provider backend for South Sudan CAP feeds."""
...
class MeteoSouthSudanBackend(WarningBackend):
    """Fetch alerts from South Sudan CAP feeds."""

    backend_id = 'meteosouthsudan'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a South Sudan CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked South Sudan CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteosouthsudan_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteosouthsudan_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a South Sudan RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the South Sudan RSS feed.
    base_url : str
