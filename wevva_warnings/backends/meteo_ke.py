"""Provider backend for Kenya Meteorological Department CAP feeds."""
...
class MeteoKEBackend(WarningBackend):
    """Fetch alerts from Kenya Meteorological Department CAP feeds."""
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Kenya CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Kenya CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _meteo_ke_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _meteo_ke_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Kenya RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Kenya RSS feed.
    base_url : str
