"""Provider backend for Kyrgyzhydromet CAP Atom feeds."""
...
class KyrgyzhydrometBackend(WarningBackend):
    """Fetch alerts from Kyrgyzhydromet CAP feeds."""

    backend_id = 'kyrgyzhydromet'
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for a Kyrgyzhydromet CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Kyrgyzhydromet CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _kyrgyzhydromet_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _kyrgyzhydromet_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from a Kyrgyzhydromet Atom feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Kyrgyzhydromet Atom feed.
    base_url : str
