"""Provider backend for Ethiopian Meteorology Institute CAP feeds."""
...
class EthiometBackend(WarningBackend):
    """Fetch alerts from Ethiopian Meteorology Institute CAP feeds."""
    ...
    def fetch_alerts(
        ...
        *,
        ...
        """Fetch alerts for an Ethiomet CAP source.
        ...
        -------
        list[Alert]
            Alerts parsed from linked Ethiomet CAP documents.
        ...
        return fetch_cap_documents(
            source,
            _ethiomet_alert_urls(root, base_url=source.url),
            preferred_lang=lang or source.lang,
            debug=debug,
        )


def _ethiomet_alert_urls(root: ElementTree.Element, *, base_url: str) -> list[str]:
    """Return candidate CAP URLs from an Ethiomet RSS feed.

    Parameters
    ----------
    root : ElementTree.Element
        Root XML element of the Ethiomet RSS feed.
    base_url : str
